            ...
            <div className="container portfolio__container">
                <article className="portfolio__item">
                    ...
                    <div className="portfolio__item-cta">
                        ...
                        <a href="https://card-graphix.herokuapp.com/" className="btn btn-primary" target="blank">Live Demo</a>
                    </div>
                ...
                <article className="portfolio__item">
                    ...
                    <div className="portfolio__item-cta">
                        ...
                        <a href="https://wl0194.github.io/Cyclist/" className="btn btn-primary" target="blank">Live Demo</a>
                    </div>
                </article>
                ...
                <article className="portfolio__item">
                    ...
                    <div className="portfolio__item-cta">
                        ...
                        <a href="https://afternoon-reaches-65972.herokuapp.com/" className="btn btn-primary" target="blank">Live Demo</a>
                    </div>
                </article>
